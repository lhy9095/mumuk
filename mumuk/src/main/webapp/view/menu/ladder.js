...
var arrList = ['보쌈', '초밥', '전', '치킨스테이크','소고기스테이크', '양꼬치', '샌드위치', '대창덮밥', '함박스테이크', '게', '카레', '백반', '소바', '만두',
			'텐동', '파스타', '쭈꾸미', '막국수', '대방어', '돼지고기구이', '소고기구이', '리조또', '바베큐', '스페인음식', '우육면', '생선요리', '순두부', 
			'마라', '스테이크덮밥', '멕시코음식', '샐러드', '규카츠', '우동', '조개', '참치', '쌀국수', '된장찌개', '샤브샤브', '카이센동',
			'제육덮밥', '짜장면', '햄버거', '치킨', '라멘', '감자탕', '부대찌개', '연어덮밥', '피자', '분짜', '돼지고기뷔페', '양고기뷔페', '돈가스', '닭발',
			'오므라이스', '칼국수', '닭갈비', '탄탄면', '떡볶이', '국수', '키토김밥', '야키니쿠동', '순대국', '해장국', '팬케이크', '닭도리탕',
			'새우', '짬뽕', '프렌치토스트', '평양냉면', '빵', '양갈비', '갈비찜', '한정식'];
var arrLength = Math.floor(Math.random()*74);
var arrFinish = arrList[arrLength]
