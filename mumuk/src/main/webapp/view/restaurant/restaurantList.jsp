...
<body onload="bmChk()">
	...
	<div class="category">
		<section class="food_category">
			...
			<div class="food_cate">
				<button class="categoryBtn" onclick="location.href='listSelected.ha?selectedFood=rice'">
			...
			<div class="food_cate">
				<button class="categoryBtn"
					onclick="location.href='listSelected.ha?selectedFood=noodle'">
					<img src="/mumuk/images/noodles.png">
					<p class="cate_txt">면</p>
				</button>
			</div>
			<div class="food_cate">
				<button class="categoryBtn" onclick="location.href='listSelected.ha?selectedFood=meat'">
					<img src="/mumuk/images/meat.png">
					<p class="cate_txt">고기</p>
				</button>
			</div>
			<div class="food_cate">
				<button class="categoryBtn" onclick="location.href='listSelected.ha?selectedFood=bread'">
			...
			<div class="food_cate">
				<button class="categoryBtn"
					onclick="location.href='listSelected.ha?selectedFood=seafood'">
					<img src="/mumuk/images/seafood.png">
					<p class="cate_txt">해산물</p>
				</button>
			</div>
			<div class="food_cate">
				<button class="categoryBtn" onclick="location.href='listSelected.ha?selectedFood=etc'">
		...
		<div class="content">
			<form action="restaurantList.ha" >
				<div class=search_wrap>
					...
					</select> <img class="search_icon" src="/mumuk/images/search_icon.png">
					<input type="search" class="search_bar" name="search_bar" value="" >
				</div>
			</form>
			...
			<section class="restaurant_list">
				...
				<div class="paging">
					...
					<c:if test="${startPage > PAGE_PER_BLOCK }">
						<button
							onclick="location.href='restaurantList.ha?pageNum=${startPage-1}&sort=${sort }'" class="btn5">이전</button>
					</c:if>
					<c:forEach var="i" begin="${startPage}" end="${endPage}">
						<button
							onclick="location.href='restaurantList.ha?pageNum=${i}&sort=${sort }'" class="btn4">${i }</button>
					</c:forEach>
					<!-- 아직 보여줄 것이 남아있다면 -->
					<c:if test="${endPage < totalPage }">
						<button
							onclick="location.href='restaurantList.ha?pageNum=${endPage+1}&sort=${sort }'" class="btn5">다음</button>
					</c:if>
				</div>
			</section>
		</div>
